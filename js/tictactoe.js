...
function stopGame() {
	...
	var btn = document.getElementById('btnStart');
	startEnabled(btn); // enable the start button since the game is now stopped, startEnabled is a created function
	var btn = document.getElementById('btnStop');
	btnDisabled(btn); // disable the stop button since the game is now stopped, btnDisabled is a function
	var showPlayer = document.getElementById('showPlayer')
...
function determineAvatar() {
	// determine the correct avatar to paint for the active player, X or O
...
function blink() {
	...
	setTimeout(function() {body.style.backgroundColor = '#383838';}, 1100);
}
